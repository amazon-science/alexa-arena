# Modified from https://github.com/alexpashevich/E.T./blob/master/alfred/nn/enc_lang.py - Licensed under the
# MIT License.
#
...
from modeling.ns_model.nn.encodings import PosLangEncoding, InstrLangEncoding
...
class EncoderLang(nn.Module):
    ...
    def forward(self, lang_pad, embedder, vocab, pad):
        ...
        mask_token = EncoderLang.mask_token(
            lang_pad, vocab, {self.subgoal_token})
